...
const Form4 = () => {
  const halfIndex = Math.ceil(form4Data.length / 2);
  const firstHalf = form4Data.slice(0, halfIndex);
  const secondHalf = form4Data.slice(halfIndex);
  ...
  return (
    <div className="container mx-auto p-4 bg-gray-200">
      <h2 className="text-3xl font-bold mb-8 mt-4 text-center">Form 4 Courses</h2>
