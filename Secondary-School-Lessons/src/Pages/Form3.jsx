...
const Form3 = () => {
  return (
    <div className="container mx-auto p-4 my-8">
      <h2 className="text-3xl font-bold mb-8 text-center">Form 3 Courses</h2>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {form3Data.map((course) => (
          <Link
            key={course.id}
            to={`/form3/${course.id}`} // Updated route to link directly to course id
          ...
          >
            ...
            <div className="bg-red-800 text-white py-2 px-4 rounded-b-lg">
